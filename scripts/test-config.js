...
console.log('  NEXT_PUBLIC_CREDITCOIN_TESTNET_RPC:', process.env.NEXT_PUBLIC_CREDITCOIN_TESTNET_RPC || process.env.NEXT_PUBLIC_CREDITCOIN_TESTNET_RPC_URL || '(default)');

const gameLogger = process.env.NEXT_PUBLIC_CREDITCOIN_GAME_LOGGER_ADDRESS || '0x0F95D1c2c4E18A17A0a0A4E3c27D5e581b58ABBE';
