...
const HowItWorksSection = () => {
  ...
  const steps = [
    ...
    {
      id: 2,
      title: 'Get CTC tokens',
      description: 'Power your gameplay with CTC tokens of Creditcoin Testnet Network.',
      emoji: '💰'
    },
    {
      id: 3,
    ...
    },
    {
      id: 4,
      title: 'Earn Rewards',
      description: 'Win CTC tokens and unlock exclusive perks through our multi-tiered loyalty program. Earn cashback on losses and gain access to tournaments.',
      emoji: '🏆'
    },
  ];
