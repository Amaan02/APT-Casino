...
const WithdrawModal = ({ isOpen, onClose }) => {
  ...
  // Display balance CTC format (18 decimals)
  const balanceInCtc = parseFloat(userBalance || '0');
  const maxWithdraw = Math.max(0, balanceInCtc - 0.01); // Reserve 0.01 CTC for gas fees
  ...
  const validateWithdraw = () => {
    ...
    if (amount < 0.001) {
      setError('Minimum withdraw amount is 0.001 CTC');
      return false;
    }
  ...
  const confirmWithdraw = async () => {
    ...
    try {
      ...
      // Deduct from user's balance (CTC uses 18 decimals)
      const currentBalance = parseFloat(userBalance || '0');
      const newBalance = currentBalance - amount;
      dispatch(setBalance(newBalance.toFixed(18)));

      setStep('success');
      toast.success(`Successfully withdrew ${amount} CTC! TX: ${result.transactionHash.slice(0, 8)}...`);
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-2">Withdraw CTC</h3>
              <p className="text-gray-400">Transfer your winnings to your CreditCoin wallet</p>
            </div>
            ...
            <div>
              <label className="block text-gray-300 mb-2">Withdraw CTC</label>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-800/50 rounded-lg p-4 space-y-3">
              <div className="flex justify-between">
                ...
                <span className="text-white font-bold">{withdrawAmount} CTC</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-yellow-400">~0.001 CTC</span>
              </div>
      ...
      case 'success':
        return (
          <div className="space-y-6 text-center">
            ...
            <p className="text-gray-400">Your CTC has been sent to your wallet</p>

            <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
              <div className="flex justify-between mb-2">
                <span className="text-gray-400">Amount Sent:</span>
                <span className="text-green-400 font-bold">{withdrawAmount} CTC</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-400">To Wallet:</span>
                <span className="text-white font-mono text-sm">{account?.slice(0, 6)}...{account?.slice(-4)}</span>
