...
const FAQContent = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "The maximum payout is 35:1 for a straight-up bet (betting on a single number). With the maximum bet of 1,000 CTC, you can win up to 35,000 CTC on a single spin."
    },
    {
