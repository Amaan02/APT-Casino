...
const RouletteHistory = ({ bettingHistory = [] }) => {
  ...
  // Open Creditcoin Testnet Explorer link for transaction hash
  const openCreditcoinExplorer = (hash) => {
    if (hash && hash !== 'unknown') {
      const explorerUrl = `https://creditcoin-testnet.blockscout.com/tx/${hash}`;
                  ...
                  <TableBody>
                    {bets.map((bet) => (
                      ...
                      >
                        ...
                        <TableCell align="center">{formatCTCAmount(bet.amount || bet.totalBetAmount || 0)} CTC</TableCell>
                          ...
                          >
                            {bet.win ? (
                              <>
                                ...
                                +{formatCTCAmount(bet.payout || bet.netResult || 0)} CTC
                              </>
                            ) : '-'}
                          </Typography>
                        </TableCell>
                        <TableCell align="center">
                          <Box
                            ...
                            sx={{
                              ...
                              padding: '4px 10px',
                              borderRadius: '6px',
                              backgroundColor: 'rgba(104, 29, 219, 0.15)',
                              border: '1px solid rgba(104, 29, 219, 0.4)',
                              color: '#681DDB',
                              transition: 'all 0.2s ease',
                              '&:hover': {
                                backgroundColor: 'rgba(104, 29, 219, 0.25)',
                                transform: 'translateY(-1px)',
                                boxShadow: '0 2px 8px rgba(104, 29, 219, 0.3)'
                              }
                            }}
                            title="View NFT Collection"
                          >
                            <FaImage size={12} color="#681DDB" />
                            <Typography variant="caption" sx={{ color: '#681DDB', fontSize: '0.75rem', fontWeight: 'bold' }}>
                              NFT
                            </Typography>
                          </Box>
                        </TableCell>
                        <TableCell align="center">
                          {bet.entropyProof || bet.creditcoinTxHash ? (
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5, alignItems: 'center' }}>
                              ...
                              <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap', justifyContent: 'center' }}>
                                <Box
                                  onClick={() => openCreditcoinExplorer(bet.creditcoinTxHash)}
                                  sx={{
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: 0.5,
