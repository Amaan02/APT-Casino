            ...
            {paginatedHistory.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    {item.entropyProof || item.creditcoinTxHash ? (
                      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          ...
                          />
                          {item.creditcoinTxHash && (
                            <Button
                              onClick={() => openCreditcoinExplorer(item.creditcoinTxHash)}
                              size="small"
                        ...
                        <Typography variant="caption" color="rgba(255,255,255,0.5)">
                          {item.creditcoinTxHash ? 'Game logged on Creditcoin' : 'Pyth Entropy'}
                        </Typography>
                      </Box>
                    ) : (
