      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        <Grid item xs={12} md={6}>
          <Box sx={{ 
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
              ...
              <Chip 
                label={`${parseFloat(getMaxMultiplier(riskLevels[activeTab].key)) * 100} CTC`}
                sx={{ 
        ...
        <Grid item xs={12} md={6}>
          <Box sx={{ 
            ...
            <Typography variant="body2" color="rgba(255,255,255,0.7)" sx={{ mb: 1 }}>
              Maximum payout: 1,000,000 CTC per spin.
            </Typography>
        ...
        <Box sx={{ p: 2, backgroundColor: 'rgba(0,0,0,0.2)', borderRadius: 2, mb: 2 }}>
          ...
          >
            <Typography variant="caption" color="rgba(255,255,255,0.6)">
              0x multiplier = loss of bet (100 CTC)
            </Typography>
              ...
              <Grid item xs={6} sm={4} md={4} key={index}>
                ...
                >
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                    <Typography variant="subtitle1" fontWeight="bold" color="white">{example.bet} CTC</Typography>
                    <Typography 
                      variant="subtitle1" 
                      fontWeight="bold" 
