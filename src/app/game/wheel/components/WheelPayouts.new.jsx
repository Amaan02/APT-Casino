    ...
    >
                    ...
                    >
                      <TableCell>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          ...
                          <Typography>{example.bet} CTC</Typography>
                        </Box>
                      </TableCell>
                      <TableCell>{example.multiplier}</TableCell>
                      <TableCell sx={{ color: '#FFA500', fontWeight: 'medium' }}>{example.payout} CTC</TableCell>
                      <TableCell sx={{ color: '#14D854', fontWeight: 'medium' }}>+{example.profit} CTC</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
      ...
      >
        ...
        <Box>
          ...
          <Typography variant="body2" color="rgba(255,255,255,0.7)">
            The maximum payout per spin is capped at 1,000,000 CTC. This means that regardless of your bet amount and the multiplier, you cannot win more than 1,000,000 CTC in a single spin.
          </Typography>
        </Box>
      </Box>
    </Paper>
